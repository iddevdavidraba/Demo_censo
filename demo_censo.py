...
for i in range(500_000):
    ...
    if len(censo) % 100_000 == 0:
        print("Creados", len(censo), "registrados")
...
def busqueda_nombre(lista, elemento):
    ...
    '''Busca registro por nombre. Busqueda lineal'''
...
def muestra_registro(registro):
    if registro == None:
        print("No exite registro con ese dato")
    else:
        print("------------------------------")
...
while True:
    ...
    if op == "1":
        ...
        nombre = input("Introduce tu numbre: ").upper()
